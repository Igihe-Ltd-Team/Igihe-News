                    ...
                    <Link href="#">
                       <span className='site-logo'>
                            <svg width="240" height="34" viewBox="0 0 240 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2928_1291)">
                        ...
                        <div className="collapse navbar-collapse gap-3" id="navbarScroll d-flex justify-content-between">
                            ...
                            <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style={{['--bs-scroll-height' as any]: '100px;'}}>
                               {menus && menus.length > 0 ? (
                                        menus.map((NavItem: any, index: number) => (
                                        ...
                                        <li className="nav-item text-muted">No Nav item</li>
                                    )}
                            ...
                            <div className="right-options d-flex align-items-center">
                                <div className="searchButton">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.5 17.5L14.5834 14.5833M16.6667 9.58333C16.6667 13.4953 13.4953 16.6667 9.58333 16.6667C5.67132 16.6667 2.5 13.4953 2.5 9.58333C2.5 5.67132 5.67132 2.5 9.58333 2.5C13.4953 2.5 16.6667 5.67132 16.6667 9.58333Z" stroke="black" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
