    ...
    return (
        ...
        <div className="video-card d-flex flex-column gap-2">
            <div className="holdes-thumbnail ">
                <OptimizedImage src={thumbNail || '/assets/igiheIcon.png'} alt={title}
                    fill
                    height={200}
                    className="object-cover video-thumbnail" imgClass='object-fit-cover' />
                <a href={`/videos/${slug}`} className="play-button">
            ...
            <div className="videos-rt-details">
                <a href={`/videos/${slug}`} className='text-decoration-none'>
